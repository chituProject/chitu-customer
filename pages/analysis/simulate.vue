...
<!--            <view class="item_font" style="font-size: 30upx">x</view>-->
      ...
      <van-field v-model="name" label="组合名" placeholder="请输入组合名" style="width: 100%;margin-top: 10upx" v-if="ratios.length>0"/>
      <view style="width: 100%">
        <view style="display: flex;margin-left: 20upx;margin-top: 10upx" v-if="show">
          <van-button round color="#ac2d38" size="small" @click="show=true,show1=false">累计</van-button>
          <van-button round type="default" size="small" style="margin-left: 20upx" @click="show1=true,show=false">年华</van-button>
        </view>
        <view style="display: flex;margin-left: 20upx;margin-top: 10upx" v-if="show1">
          <van-button round type="default" size="small" @click="show=true,show1=false">累计</van-button>
          <van-button round color="#ac2d38"  size="small" style="margin-left: 20upx" @click="show1=true,show=false">年华</van-button>
        </view>
        ...
        <view style="justify-content: flex-end;display: flex;margin: -5upx 10upx">数据更新至2020年5月</view>
        <view style="margin-top: 25upx;background: #FFFFFF;width: 100%;padding: 25upx">
          <view style="display: flex;">
            <div style="display:flex;height: 30upx;background: #fafafa;border-radius: 20upx;padding: 15upx" @click="popup1showbtn">
              <p style="line-height: 30upx;color: #9a1f27;">
                {{ data || '请选择时间' }}
              </p>
              <div class="arrow-down" style="margin-left: 15upx"></div>
            </div>
            <div style="display:flex;height: 30upx;background: #fafafa;border-radius: 20upx;padding: 15upx;margin-left: 15upx" @click="popup2=true">
              <p style="line-height: 30upx;color: #9a1f27">
                {{ data1 || '请选择时间' }}
              </p>
              <div class="arrow-down" style="margin-left: 15upx"></div>
